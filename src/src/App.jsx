...
- After 2-3 exchanges, gently point out 1-2 phrases that could sound more natural (show the original + the improved version inline, briefly).
- Encourage specificity: if they’re vague, ask “Can you give me an example?” or “What do you mean by that?”
- NEVER break the conversational flow with a grammar lecture. Corrections should feel like a coach whispering, not a teacher interrupting.
- Suggest B2-level vocabulary naturally: e.g. “By the way, native speakers often say ‘…’ instead of ‘…’ — just something to keep in mind!”
...
function ReadingModule({ profile }) {
const [text, setText] = useState(””);
const [analysis, setAnalysis] = useState(null);
const [loading, setLoading] = useState(false);
const [mode, setMode] = useState(“paste”); // paste | sources
...
<p style={{ margin: 0, fontSize: 12, color: “#666” }}>Based on Thiago Alencar’s B2 framework. Tap any topic to start a mini-lesson.</p>
</div>
...
```
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 24 }}>
      {[
        { label: "Day Streak", value: days, icon: "🔥", color: "#f97316" },
